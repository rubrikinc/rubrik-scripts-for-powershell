...
$return = [ordered]@{
            ...
            'Total DB Size (GB)' = (($rawdata | Measure-Object -Property DBTotalSizeMB -Sum).Sum).ToString('0.00')
            ...
            'Estimated Daily Change Rate (GB)' = ((($rawdata | Measure-Object -Property DBTotalSizeMB -Sum).Sum) * $EstimatedChangePerc).ToString('0.00')
